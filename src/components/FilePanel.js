...
export class FilePanel extends Panel
{
  constructor(x,y)
  {
    ...
    buttonYPosition++;
    let aboutButton = new TextButton(this.x+1,this.y+1+buttonYPosition++,"About");
    HelpLine.help.assignHelpText(aboutButton, "About this app");
    let t = this;
    aboutButton.press = function(){
      let aboutPopup = new Popup("About", 32, 8, 32, 16);
      aboutPopup.onRequestClose = ()=>{
        t.removeChild(aboutPopup);
        Drawing.currentDrawing.redrawAll();
      }
      t.addChild(aboutPopup);
    };
